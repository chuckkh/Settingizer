...
namespace BinaryData
{
    ...
    extern const char*  knobHw001_png;
    const int           knobHw001_pngSize = 8674;

    extern const char*  knobVb001_png;
    const int           knobVb001_pngSize = 8621;

    extern const char*  knobVw001_png;
    const int           knobVw001_pngSize = 8742;
